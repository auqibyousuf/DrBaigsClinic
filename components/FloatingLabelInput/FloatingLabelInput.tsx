...
export const fieldClasses = (error?: string) =>
  `w-full text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-800/60 border transition-colors duration-150 focus:outline-none focus:bg-white dark:focus:bg-gray-800 placeholder-gray-400 dark:placeholder-gray-500 ${
    error
